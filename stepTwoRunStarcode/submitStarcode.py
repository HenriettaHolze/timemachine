...
outFileDirectory = os.path.join(experimentDirectory,  args.sampleName, 'starcode')
if not os.path.exists(outFileDirectory):
        os.makedirs(outFileDirectory)

outfilePath = os.path.join(outFileDirectory, '{}_clusteredBarcode{}_d{}.txt'.format(args.sampleName, args.countType, args.distance))
